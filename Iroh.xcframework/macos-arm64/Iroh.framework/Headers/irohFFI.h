...
void uniffi_iroh_fn_method_irohnode_blobs_download(void*_Nonnull ptr, void*_Nonnull hash, void*_Nonnull req, uint64_t cb, RustCallStatus *_Nonnull out_status
);
