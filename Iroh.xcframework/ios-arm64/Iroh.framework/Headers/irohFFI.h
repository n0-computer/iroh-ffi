...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_IROH_FFI_FN_CONSTRUCTOR_IROHNODE_CREATE
#define UNIFFI_FFIDEF_UNIFFI_IROH_FFI_FN_CONSTRUCTOR_IROHNODE_CREATE
uint64_t uniffi_iroh_ffi_fn_constructor_irohnode_create(RustBuffer path
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_IROH_FFI_FN_CONSTRUCTOR_IROHNODE_NEW
#define UNIFFI_FFIDEF_UNIFFI_IROH_FFI_FN_CONSTRUCTOR_IROHNODE_NEW
uint64_t uniffi_iroh_ffi_fn_constructor_irohnode_new(RustBuffer path
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_IROH_FFI_FN_CONSTRUCTOR_IROHNODE_WITH_OPTIONS
#define UNIFFI_FFIDEF_UNIFFI_IROH_FFI_FN_CONSTRUCTOR_IROHNODE_WITH_OPTIONS
uint64_t uniffi_iroh_ffi_fn_constructor_irohnode_with_options(RustBuffer path, RustBuffer options
);
#endif
...
RustBuffer uniffi_iroh_ffi_fn_method_irohnode_node_id(void*_Nonnull ptr, RustCallStatus *_Nonnull out_status
);
#endif
...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_IROH_FFI_CHECKSUM_CONSTRUCTOR_IROHNODE_CREATE
#define UNIFFI_FFIDEF_UNIFFI_IROH_FFI_CHECKSUM_CONSTRUCTOR_IROHNODE_CREATE
uint16_t uniffi_iroh_ffi_checksum_constructor_irohnode_create(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_IROH_FFI_CHECKSUM_CONSTRUCTOR_IROHNODE_NEW
#define UNIFFI_FFIDEF_UNIFFI_IROH_FFI_CHECKSUM_CONSTRUCTOR_IROHNODE_NEW
uint16_t uniffi_iroh_ffi_checksum_constructor_irohnode_new(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_IROH_FFI_CHECKSUM_CONSTRUCTOR_IROHNODE_WITH_OPTIONS
#define UNIFFI_FFIDEF_UNIFFI_IROH_FFI_CHECKSUM_CONSTRUCTOR_IROHNODE_WITH_OPTIONS
uint16_t uniffi_iroh_ffi_checksum_constructor_irohnode_with_options(void
