...
void uniffiFutureCallbackHandlerEntryTypeIrohError(void *, void*, RustCallStatus);
...
void uniffiFutureCallbackHandlerTypeInsertRemoteEventTypeIrohError(void *, RustBuffer, RustCallStatus);
void uniffiFutureCallbackHandlerTypeOpenStateTypeIrohError(void *, RustBuffer, RustCallStatus);
void uniffiFutureCallbackHandlerTypeSyncEventTypeIrohError(void *, RustBuffer, RustCallStatus);
