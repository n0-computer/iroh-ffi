...
//     const hash = doc.setBytes(author, key, val);
...
//     const node = new IrohNode.withPath(irohDir);
//     const doc = node.docCreate();
//     const author = node.authorCreate();
//     const key = pathToKey(path, null, inRoot);
//     doc.importFile(author, key, path, true, null);
//     const query = Query.authorKeyExact(author, key);
//     const entry = doc.getOne(query);
